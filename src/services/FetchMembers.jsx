...
export const MembersComponent=  ( {members = [] }) => {
  ...
  <div className="card-body p-4 flex flex-col min-h-0">
            <h2 className="card-title text-primary tracking-tighter uppercase text-xl font-black mb-2 shrink-0">
              Groups Members
            </h2>

            {/* Scrollable table area */}
            <div className="border border-base-300 rounded-box flex-1 min-h-0 overflow-hidden">
